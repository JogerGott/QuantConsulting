...
gdp = web.datafrader('GDP','fred',start, end)
...
spx = pdr.get_data_stoop('^SPX') #Research on internet 
spx.head()
spx['shift1'] = spx['Close']/spx['Close'].shift1(-1)-1) #Expresa la volatilidad 
...
!pip_intall requests beautifulsoup4 #Install librari to make a scrape 
